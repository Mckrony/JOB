...
<div class="w3-container w3-padding-64 w3-center" id="team">
    ...
    <div class=""><br>
        ...
        <div class="col-sm-3">
            <img src="favicon/soham.jpg" alt="Boss" style="width:120px; height: 125px" class="w3-circle w3-hover-opacity">
            <h3>Soham Roy</h3>
            <p>UI Developer</p>
        </div>

        <div class="col-sm-3">
            <img src="favicon/aditya.jpg" alt="Boss" style="width:120px; height: 125px" class="w3-circle w3-hover-opacity">
            <h3>Aditya Rahut</h3>
            <p>Admin Developer</p>
        </div>

        <div class="col-sm-2">
            <img src="favicon/ivy.jpg" alt="Boss" style="width:120px; height: 125px" class="w3-circle w3-hover-opacity">
            <h3>Ivy Saha</h3>
            <p>Analyst & Debugger</p>
        </div>

        <div class="col-sm-2">
            <img src="favicon/tom.jpg" alt="Boss" style="width:120px; height: 125px"class="w3-circle w3-hover-opacity">
            <h3>Tanay Das</h3>
            <p>Quality Assurance</p>
        </div>

        <div class="col-sm-2">
            <img src="favicon/sreeparna.jpg" alt="Boss" style="width:120px; height: 125px"class="w3-circle w3-hover-opacity">
